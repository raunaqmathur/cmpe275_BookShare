...
public class BookController {
    ...
    public ModelAndView showBook(@PathVariable int bookId, HttpServletRequest request) {
        ...
        String fullPath = appPath + imagePath +  "\\" + bookId + "\\" + bookId + ".jpg";      
        File bookImage = new File(fullPath);
    	
        System.out.println("fullPath = " + fullPath);
        
        if(bookImage.exists())
        {
        	mv.addObject("imagePath", imagePath +  "\\" + bookId + "\\" + bookId + ".jpg");
        	
        	System.out.println("1 = " + fullPath);
        }	
        	else
        	{
        		mv.addObject("imagePath", appPath + imagePath +  "\\default.jpg");
        		System.out.println("2 = " + appPath + imagePath +  "\\default.jpg");
        	}
        	*/
